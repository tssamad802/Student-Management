            ...
            <div class="bg-white rounded-lg shadow-sm p-8">
                <form action="includes/edit.inc.php" method="post">
                    ...
                    <div class="mb-8">
                        ...
                        <select name="class" id="class" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200">
